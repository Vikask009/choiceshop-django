...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            mail_subject = 'Account verification email'
            message = render_to_string('accounts/account-verification_email.html', {
                'user': user,
                'domain': current_site,
            ...
            # messages.success(request, 'Thank you for registering with us. we have sent you a verification email to your email address plese verify it.')
...
#                 user = Account.objects.all().filter(email__exact=email)
...
#                 send_email = EmailMessage(mail_subject, message, to=[to_email])
#                 send_email.send()
#                 messages.success(request, 'Password reset email has been send your email address.')
#                 return redirect('login')
